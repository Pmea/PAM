...
% calcul la similarité entre tout les morceaux de la structure
...
% qui vont etre utilisé pour calculer la matrice de penalité
...
%           Autre calcule possible, non effectué a chaque fois du au temps de calcule 
...
%             c_mor{ref}.watermanInterval{etu}.chemin= chemin;
    ...
    % calculé avec le smith waterman 
    ...
    dist= dist + 0.4;  % dist + une seuil car l'algorithme ne marche qu'avec 
                       % des valeurs positives. Si le morceau est le même
